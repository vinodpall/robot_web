...
const internetConfig: EnvironmentConfig = {
  ...
  websocket: {
    host: '10.10.1.82',
    port: 8000,
    fullUrl: 'ws://10.10.1.82:8000'
  },
  video: {
    webrtcDomain: 'webrtc://10.10.1.82:8000',
    rtmpDomain: 'rtmp://10.10.1.82:8000'
  },
  services: {
    vision: 'http://10.10.1.82:8000',
    livestream: 'http://10.10.1.82:8000',
    mapFile: 'http://10.10.1.82:5000'
  }
}
